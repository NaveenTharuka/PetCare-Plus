...
export default function LandingPage() {
  ...
  const [sanctuaryRef, sanctuaryVisible] = useReveal();
    ...
    <main className="pt-20">
      ...
      <section className="px-8 py-20 md:py-15 max-w-screen-2xl mx-auto overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          <div className="lg:col-span-6 space-y-10">
            <h1 className={`${styles.heroItem} font-headline text-5xl md:text-7xl font-extrabold tracking-tight text-on-surface leading-[1.1]`}>
              Every pet has a story. We help you <span className="text-primary">care for it.</span>
            </h1>
            <p className={`${styles.heroItem} text-xl md:text-2xl text-on-surface-variant max-w-xl leading-relaxed`}>
              The all-in-one sanctuary for your pet&apos;s medical history, daily routines, and wellness journey.
            </p>
            <div className={`${styles.heroItem} flex flex-col sm:flex-row gap-4 pt-4`}>
          ...
          <div className={`${styles.heroImage} lg:col-span-6 relative`}>
            <div className="relative z-10 rounded-xl overflow-hidden shadow-2xl transform rotate-2 transition-transform duration-500 hover:rotate-0">
      ...
      <section className="px-8 py-24 bg-surface-container-low">
        <div className="max-w-screen-2xl mx-auto">
          ...
          <div
            ref={bentoRef}
            className={`${styles.reveal} ${bentoVisible ? styles.visible : ''} grid grid-cols-1 md:grid-cols-4 grid-rows-2 gap-8 h-auto md:h-[800px]`}
          >
            {/* Feature: Medical Records */}
            <div className={`${styles.staggerChild} md:col-span-2 md:row-span-2 bg-surface-container-lowest p-10 rounded-xl border border-outline-variant/10 flex flex-col justify-between group overflow-hidden relative`}>
            ...
            <div className={`${styles.staggerChild} md:col-span-2 bg-tertiary-container p-10 rounded-xl flex flex-col justify-center`}>
            ...
            <div className={`${styles.staggerChild} md:col-span-1 bg-surface-container-lowest p-8 rounded-xl border border-outline-variant/10`}>
      ...
      <section className="py-32 px-8">
        <div className="max-w-5xl mx-auto text-center space-y-12">
          ...
          >
            ...
            <div className={`${styles.staggerChild} space-y-4 pt-12`}>
              <div className="h-80 rounded-xl overflow-hidden mb-6">
                <img className="w-full h-full object-cover transition-transform duration-700 hover:scale-105" alt="close up of a small fluffy dog looking up with curious eyes in a bright white studio setting" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBJYHxhNNBRxnqgHG6iVM6870gdgpJch26hNpCm_7dmtehKTy3Mg_l-uyJ2XFrWUwQHvDPWtFzb2FKncQ_7zpCP44gpgBQXlSa7VcKdAigQ1zyKNPfZhXDfjZYLZum5YvTrScHuoqxE33mEXL7yjqA2_o7ERx2FYTVPf9a2D1gQBfbpf11RbJRso0NIK0GT_ZPORVYlqtZl8WbTtb23pUQ5aP3lVG-bLSqX__1NGQD89d5g-p7LCiaTb_20ghZwrujJtccyNxx6Urs" />
              </div>
            ...
            <div className={`${styles.staggerChild} space-y-4`}>
              <div className="h-80 rounded-xl overflow-hidden mb-6">
                <img className="w-full h-full object-cover transition-transform duration-700 hover:scale-105" alt="two playful dogs running together in a grassy field during a warm orange sunrise" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBWna-8mTBDHMHq33_kJqsTOcg89so0YbWuYoBrSBBv6to3r8BYwYRt0955aF5PYxydjdvZJCBEVv7y9SKdRXtPpSsOEqOGoASmYpZX1I3cKb3ryq0q8fbD8B8N9-HNmVgnASye5ud_4tuzg_g6sKemYm1Ei6WEFXctUD3-V5t2qmYgjw8zIlCT1acmN-Kgl5L_z4qez8rcpSBW45Xa1pIE0e9UmoKi9ZMMLx5xRDhXgdPPySXurWP8UoKhHKTCny8hdDpBrv3Wgeo" />
              </div>
      ...
      <section className="px-8 py-24">
        <div
          ref={ctaRef}
          className={`${styles.reveal} ${ctaVisible ? styles.visible : ''} max-w-7xl mx-auto primary-satin-gradient rounded-xl p-12 md:p-24 text-center text-on-primary relative overflow-hidden`}
        >
